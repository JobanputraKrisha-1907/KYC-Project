...
/* harmony import */ var _home_registration_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./home/registration.component */ "./src/app/home/registration.component.ts");
...
AppModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _home_registration_component__WEBPACK_IMPORTED_MODULE_11__["RegistrationComponent"],
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot([
                ...
                { path: 'registration', component: _home_registration_component__WEBPACK_IMPORTED_MODULE_11__["RegistrationComponent"] },
            ]),
        ],
        providers: [],
...
let HomeComponent = class HomeComponent {
    ...
    LoginBtn(frmLogin) {
        ...
        if (frmLogin.valid) {
            ...
            this.http.post(`Home/LoginData`, { "JsonData": JSON.stringify(param) }).pipe().subscribe(data => {
                ...
                if (data[0].MSG == "1") {
                    ...
                    this.show = !this.show;
                    this.buttonName = "Invalid email or password";
                }
            }, error => { });
        }
        else {
...
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('frmLogin', { static: true }),
    __metadata("design:type", Object)
], HomeComponent.prototype, "frmLogin", void 0);
HomeComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-home',
        template: __importDefault(__webpack_require__(/*! raw-loader!./home.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home/home.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ../../assets/css/FundBazarLogin.css */ "./src/assets/css/FundBazarLogin.css")).default]
    }),
...
let RegistrationComponent = class RegistrationComponent {
    ...
    toEnable(frmRegister) {
        this.frmRegister.submitted = true;
        if (this.frmRegister.valid) {
            let param = {
                "cemail": this.email
            };
            this.http.post(`Registration/checkEmail`, { "JsonData": JSON.stringify(param) }).pipe().subscribe(data => {
                data = JSON.parse(data.data);
                if (data[0].MSG == "1") {
    ...
    toEnablemobverifier(frmRegister) {
        this.frmRegister.submitted = true;
        if (this.frmRegister.valid) {
            let param = {
                "cmobile": this.mobile
            };
            this.http.post(`Registration/checkMobile`, { "JsonData": JSON.stringify(param) }).pipe().subscribe(data => {
                data = JSON.parse(data.data);
                if (data[0].MSG == "1") {
    ...
    submitdata(frmRegister) {
        ...
        if (this.frmRegister.valid) {
            let param = {
                "cname": this.name, "cemail": this.email, "cmobile": this.mobile, "cpass": this.pass
            };
            this.http.post(`Registration/submitData`, { "JsonData": JSON.stringify(param) }).pipe().subscribe(data => {
                data = JSON.parse(data.data);
                this.sdata = data;
...
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('frmRegister', { static: true }),
    __metadata("design:type", Object)
], RegistrationComponent.prototype, "frmRegister", void 0);
RegistrationComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-registration',
        template: __importDefault(__webpack_require__(/*! raw-loader!./registration.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/home/registration.component.html")).default
    }),
...
module.exports = __webpack_require__(/*! C:\Users\trainee5\source\repos\ProjectPages\ClientApp\src\main.ts */"./src/main.ts");
